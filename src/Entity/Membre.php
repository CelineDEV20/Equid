...
class Membre implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Note", mappedBy="membre_notant")
     */
    private $notes;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Commentaire", mappedBy="membre")
     */
    ...
    public function removeNote(Note $note): self
    {
        if ($this->notes->contains($note)) {
            ...
            if ($note->getMembreNotant() === $this) {
                $note->setMembreNotant(null);
            }
        }
